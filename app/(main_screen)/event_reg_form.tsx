        ...
        <View style={{
          ...
          <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Profile')}>
              <Image source={require('./assets/profile-icon.png')} style={{ width: 30, height: 30 }} />
            </TouchableOpacity>
          </View>

          <TouchableOpacity onPress={pickImage}>
            <Image source={image ? { uri: image } : require('./assets/camera-icon.png')} style={{ width: 50, height: 50 }} />
          </TouchableOpacity>
          ...
          {showDatePicker && (
            <DateTimePicker value={new Date()} mode="datetime" display="default" onChange={handleDateChange} />
          )}
          ...
          <TouchableOpacity onPress={pickDocument} style={{ marginTop: 10, padding: 10, backgroundColor: 'green' }}>
            <Text style={{ color: 'white' }}>Attach File</Text>
          </TouchableOpacity>

          {file && <Text>Attached: {file.name}</Text>}
          <TouchableOpacity style={{ marginTop: 20, padding: 15, backgroundColor: 'green', alignItems: 'center' }}>
